...
public class OutputHandler {
    ...
    public void showPassList(List<StudyCafeSeatPass> passes) {
        System.out.println();
    ...
    public void showPassOrderSummary(StudyCafeSeatPass selectedPass, StudyCafeLockerPass lockerPass) {
        ...
        int totalPrice = selectedPass.calculateTotalPrice(lockerPass);
    ...
    private String display(StudyCafePass studyCafeSeatPass) {
        StudyCafePassType passType = studyCafeSeatPass.getPassType();
        int duration = studyCafeSeatPass.getDuration();
        int price = studyCafeSeatPass.getPrice();
